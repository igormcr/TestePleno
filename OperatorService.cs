...
namespace TestePleno.Services
{
    public class OperatorService
    {
        ...
        public Operator GetOperatorByCode(Operator op)
        {

            var operators = _repository.GetAll<Operator>();
            var selectedOperator = operators.FirstOrDefault(o => o.Code == op.Code);
            if(selectedOperator == null) { Console.WriteLine("Operadora não encontrada, selecionando operadora pesquisada."); }
